...
<nav class="bg-gradient-to-br from-stone-500 via-orange-200 to-slate-500">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <a href="#" class="text-grey bg-slate-500 hover:bg-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-to-slate-500 focus:outline-none dark:focus:ring-blue-800">Sign up</a>
