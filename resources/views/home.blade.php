...
<hr class="my-20 border-t-4"/>
    ...
    <!-- Footer -->
    <div>
    <footer class="bg-gradient-to-br from-stone-500 via-orange-200 to-slate-500 mt-96">
    ...
    <div class="md:text-center text-center container flex items-center justify-center mx-auto py-7 px-6">
